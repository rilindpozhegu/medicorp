    ...
    <div class="container">
        <div class="row">
             ...
             <div class="col-md-offset-2">
              <ul class="nav nav-pills nav-fill buttons_dia  wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">

                    <li role="presentation" class="active button_dia_s">
                        <a href="#home" aria-controls="home" role="tab" data-toggle="tab" class="buton_on_activ_diagno">Imaging And X-Ray</a>
                    </li>
                    <li role="presentation" class="button_dia_s">
                        <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Laboratory</a>
                    </li>
              </ul>
              </div>
              <!-- Tab panes -->
                <div class="tab-content tab_cont_text_img_dia" style="width: 100% !important;">
                    ...
                    <section class="owl-carousel">
                        ...
                        <div class="col-md-9 let_ip">
                            ...
                            <p>
                            •    It’s a medical imaging technology which improves communications with referring physicians and speed time to treatment.<br>
                            •   It provides economical storage of and convenient access to images from multiple modalities (source machine type).<br>
                            •   Web enabled with ability to perform Teleradiology including reporting.
