...
<section class="cover_section_about cover_all_pages">
    <div class="container">
        <div class="row">
...
<section class="about_the_medicorp wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="img/random/image1_ho-01.png" class="img-responsive">
            </div>
            <div class="col-md-6 text_inside">
                ...
                <button class="button_default wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".5s">Contact</button>
            </div>
        </div>
    </div>
</section>
...
<!-- Third Section with three insections -->
<section class="third_section_about">
    <div class="container-fluid">
        <div class="row">
            <div class="third_panel_section1 dark_section_about row" style="margin: 0px;">
                <div class="col-md-6  no_padding">
                    <img src="img/random/image1_ho-01.png">
                </div>
                <div class="col-md-6 third_section_text_img">
                    <h1 class=" wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".1s"">Our Mission</h1>
                    <p class=" wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">The MediCorp Gulf medical clinic (MMC) is one of the most prestigious and dedicated private treatment and diagnostic facilities in the GCC. We have built our reputation on a passion for first class healthcare and for creating an environment that puts patients completely at ease.</p>
                    <button class="button_default  wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">Doctors</button>
                </div>
            </div>
            ...
            <div class="third_panel_section1 dark_section_about row" style="margin: 0px;">
                <div class="col-md-6  no_padding">
                    <img src="img/random/hospital3_ab-01.png">
                </div>
                <div class="col-md-6 third_section_text_img">
                    ...
                    <button class="button_default wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".4s">Apply Now</button>
                </div>
            </div>
