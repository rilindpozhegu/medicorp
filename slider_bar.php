  ...
  <!-- Controls -->
  <a class="left carousel-control mobile-d-n" href="#carousel-example-generic" role="button" data-slide="prev" style="z-index: 1">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control mobile-d-n" href="#carousel-example-generic" role="button" data-slide="next"  style="z-index: 1">
